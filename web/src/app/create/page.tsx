  ...
  return (
    <div className="mx-auto max-w-xl px-5 py-16 sm:py-20">
      ...
      <p className="mt-4 text-base text-bone-dim/70">
        Any ERC20 qualifies. Feed it a little blood and we spin up a real chain that runs on your
        token as gas — then split its revenue three ways with you and the chain&apos;s own runway,
        forever, for as long as it&apos;s alive.{" "}
