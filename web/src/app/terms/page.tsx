export default function TermsPage() {
  return (
    <div className="prose prose-invert max-w-2xl space-y-4 text-sm leading-6 text-neutral-300">
      <h1 className="text-2xl font-bold text-neutral-100">Terms &amp; disclaimers</h1>

      <p>
        vampchains is early, unaudited, experimental software. Read this before you send anything
        of real value through it.
      </p>

      <h2 className="text-lg font-semibold text-neutral-100">What this actually is</h2>
      <p>
      ...
      <h2 className="text-lg font-semibold text-neutral-100">Funding &amp; chain lifecycle</h2>
      <p>
      ...
      <h2 className="text-lg font-semibold text-neutral-100">Acceptable use</h2>
      <p>
        ...
        in any way — it&apos;s infrastructure, not a listing or an investment product, and nothing here is
        investment advice.
      </p>

      <h2 className="text-lg font-semibold text-neutral-100">No warranty</h2>
      <p>
